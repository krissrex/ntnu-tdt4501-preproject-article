...
This means that almost all functionality is provided as an extension.
For example, the \acrshortpl{API} for user-installable plugins are provided as an extension. %TODO: Add reference to extensions/plugins sections
